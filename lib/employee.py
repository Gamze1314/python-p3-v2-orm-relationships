...
from department import Department # update Employee class to store the relationship to Department.
...
class Employee:
    ...
    def __init__(self, name, job_title, department_id, id=None): # department_id added as attribute to store the value.
        self.id = id
        self.name = name
    ...
    @classmethod
    def create_table(cls): # UPDATE TABLE TO ADD DEPARTMENT_ID INTO TABLE
